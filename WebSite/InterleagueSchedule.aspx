<%@ Page Language="C#" MasterPageFile="~/masterMain.master" AutoEventWireup="true" CodeFile="InterleagueSchedule.aspx.cs" Inherits="DistrictOne.InterleagueSchedule" Title="Interleague Schedule" %>
        ...
        <div class="container">
            <div class="row" style="background-color: lavender">
                <div class="col-sm-12 text-center">
                    ...
                    <br />
                    <span style="font-size: 18px; color: #000066; font-family: Calibri">NJ Interleague Game Schedule</span><br />
                </div>
            </div>
        </div>
        <br />
            ...
            <div class="row border border-primary text-center">
                <div class="col-sm-12 p-1">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 text-center">
                            <span class="col-form-label-lg">Team</span>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-sm-6 d-flex justify-content-center">
                            <asp:ListBox CssClass="list-group" ID="lstTeam" runat="server" SelectionMode="Multiple">
